...
#replset='vivo_01'
replset=`mongo --eval 'rs.conf()._id' --quiet`
...
#/usr/bin/mongodump --host localhost --port 27017 --username=admin --password=anORgdGl67mWJAowR6VqIfzdQi52AlbB --authenticationDatabase=admin --out $DEST --oplog\
